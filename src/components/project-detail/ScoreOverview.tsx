...
export function ScoreOverview({
  ...
  const { totalScore, categoryScores, lastUpdated, redFlagCount } =
    analysisResult;
          ...
          <div className="flex-1">
            <div className="mb-4">
              <p className="heading-secondary text-1 text-[--color-text-dark] mb-1">
                Your project analysis identified{' '}
              ...
              <p className="text-3 text-[--color-bg-3]">
                Click on any category to expand and see detailed red flags and
                recommendations.
              </p>
            </div>
          </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <span className="mr-2">
                        {CATEGORY_DESCRIPTIONS[category.category].icon}
                      </span>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-[--color-secondary] text-2">
                        {category.redFlags.length}{' '}
                        {category.redFlags.length === 1 ? 'issue' : 'issues'}
                      </span>
                      <svg
                ...
                {isExpanded && (
                  <div className="border-t border-[--color-bg-1] p-4">
                    ...
                    {category.redFlags.length > 0 ? (
                      <div className="space-y-3">
                        <h4 className="heading-primary heading-3 text-[--color-text-dark] mb-2">
                          IDENTIFIED ISSUES
                        </h4>
                        {category.redFlags.map((redFlag) => (
                          ...
                          >
                            <div className="flex flex-wrap justify-between items-start mb-1">
                              ...
                              <div className="flex items-center">
                                <span
                                  className={`ceart-score-badge mr-2 ${
                                    redFlag.impact === 'high'
