...
export function ProjectList({ projects, isLoading = false, error }: ProjectListProps) {
  if (isLoading) {
    return (
      <div className="mt-6 grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" data-testid="project-list-loading">
        {[...Array(6)].map((_, index) => (
          <div
            key={index}
  ...
  if (error) {
    return (
      <div className="mt-6 p-4 border-2 border-[--color-secondary] bg-[#FFF0EE] rounded-lg text-[--color-secondary]" data-testid="project-list-error">
  ...
  if (projects.length === 0) {
    return (
      <div className="mt-6 p-6 border-2 border-[--color-neutral-1] rounded-lg bg-white text-center" data-testid="project-list-empty">
  ...
  return (
    <div className="mt-6 grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" data-testid="project-list">
