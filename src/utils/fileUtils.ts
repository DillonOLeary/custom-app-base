...
export function organizeFilesIntoFolders(files: FileUpload[]): {
  folders: Folder[];
...
export function connectRedFlagsToFiles(
  files: FileUpload[],
  redFlags: RedFlag[],
): FileUpload[] {
...
export function addMissingFilesToFolders(
  folders: Folder[],
  redFlags: RedFlag[],
): Folder[] {
...
export function processFilesForProject(
  files: FileUpload[],
  redFlags?: RedFlag[],
): {
  folders: Folder[];
